...
# To run the model on cpu or gpu select below:
run_on = 'cpu'
...
# print(help(results.show))


if run_on == 'gpu':
    for result in results:
        corner_xy_list.append(result.keypoints.xy.cpu())
        bounding_box.append(result.boxes.xyxy.cpu())
else:
    for result in results:
